import { buildStreak, differenceInDays, formattedDate, KEY, type Streak, updateStreak } from './utils'
...
export function streakCounter (storage: Storage, date: Date): Streak {
  ...
  if (streakInLocalStorage != null) {
    try {
      const streak: Streak = JSON.parse(streakInLocalStorage) as Streak
